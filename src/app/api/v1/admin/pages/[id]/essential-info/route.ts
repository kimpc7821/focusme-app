...
/**
 * PATCH /api/v1/admin/pages/:id/essential-info — admin 측 essential_info 수정.
 *
 * 사장님이 오타·잘못 입력 시 직원이 직접 고칠 수 있도록 admin 측 PATCH 제공.
 * 사장님 측 (`/api/v1/me/pages/:id/essential-info`) 과 같은 deep-merge 로직.
 * essential_info 는 v2 단일 source of truth — 6개 시스템·숨김 블록에 자동 주입.
 */
