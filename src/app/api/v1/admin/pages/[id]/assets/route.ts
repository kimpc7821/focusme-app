...
/**
 * POST /api/v1/admin/pages/:id/assets — multipart 파일 업로드.
 * fields:
 *  file      — Blob (required)
 *  category  — logo / main_image / product_image / lifestyle / text / other
 *  blockId   — optional, 특정 블록에 묶을 때
